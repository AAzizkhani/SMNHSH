...
class operation
{
    ...
    void setAlltype(unordered_map<string , int> &,int, vector<int>, saveDirect [V], bool[V]);
    void set_bus_line1(unordered_map<string , int> & t,  int index,int, vector<int> timeoftype, saveDirect dir[V],int , int);
    void set_bus_line2(unordered_map<string , int> & t,  int index,int, vector<int> timeoftype, saveDirect dir[V], int, int);
    void set_bus_line3(unordered_map<string , int> & t,  int index,int, vector<int> timeoftype, saveDirect dir[V],int , int);
    void set_sub_line1(unordered_map<string , int> & t,  int index,int, vector<int> timeoftype, saveDirect dir[V], int , int);
    void set_sub_line2(unordered_map<string , int> & t,  int index,int, vector<int> timeoftype, saveDirect dir[V], int , int);
    void set_sub_line3(unordered_map<string , int> & t, int index,int, vector<int> timeoftype, saveDirect dir[V], int , int);
    void set_sub_line4(unordered_map<string , int> & t, int index,int, vector<int> timeoftype, saveDirect dir[V],  int , int);
    void set_taxi_line1(unordered_map<string , int> & t,  int index,int, vector<int> timeoftype, saveDirect dir[V], int , int);
